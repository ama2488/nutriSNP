    ...
    .then(() =>
      // Inserts seed entries
       knex('phenotype_ntr').insert([
        ...
        { id: 2, name: 'low fat', description: 'For weight loss, those with your genetic makeup lose 2.5 times as much weight on a low fat diet.', carb: 55, fat: 20, protein: 25 },
